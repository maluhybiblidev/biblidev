...
echo '
  ...
  <br>
    ...
    if (isset($_GET['id'])) {
      $resp = $tiposUsuarios->EditTipoUsuarios($_GET['id']);
              ...
              <!-- form start -->
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" maxlength="20" class="form-control" name="tipo_usuario" id="tipo_usuario" placeholder="Tipo Usuários" value="'.$resp['tipo_usuario'].'">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number"
                            maxlength = "3" class="form-control" id="limite_livros_emprestimo" name="limite_livros_emprestimo" placeholder="Limite Livros Empréstimo" value="'.$resp['limite_livros_emprestimo'].'">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number"
                            maxlength = "3" class="form-control" id="limite_dias_emprestimo" name="limite_dias_emprestimo" placeholder="Limite Livros Empréstimo" value="'.$resp['limite_dias_emprestimo'].'">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <script>
                      ...
                      setValueList("administrar_usuarios", '.$resp['administrar_usuarios'].');  
                      setValueList("administrar_livros", '.$resp['administrar_livros'].');    
                      setValueList("administrar_emprestimos", '.$resp['administrar_emprestimos'].');    
                      setValueList("ativo", "'.$resp['ativo'].'");
                  </script>                    

                  <input id="iduser" type="hidden" name="iduser" value="'.$idUsuario.'">
                  <input id="idtipo_usuario" type="hidden" name="idtipo_usuario" value="'.$resp['idtipo_usuario'].'">
                  <p class="text-muted text-center"><strong>Campos com "*" são obrigatórios</strong></p>

                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <a type="submit" name="update" value="updatetipousuarios" class="btn btn-info btn-update_tipo_usuarios">Salvar Modificações</a>
...
echo '
      <div class="modal fade" id="modalTipoUsuarioEditSuccess">
            ...
            <div class="modal-body">
              <section class="content">
                <div class="justify-content">
                  ...
                  <div>
                    <h3 class="text-center" id="tituloTipoUsuarioEditSuccess"></h3>
                    <p class="text-muted text-center" id="mensagemTipoUsuarioEditSuccess"></p>
                  </div>
                </div>              
              </section>
            </div>
            <div class="modal-footer justify-content-center">
              <a href="tiposusuario.php" type="submit" class="btn btn-block btn-success btn-ok_tipo_usuario_update">OK</a>
            </div>
          </div>
        </div>
      </div>
