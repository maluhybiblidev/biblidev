                ...
                <table class="table table-bordered table-striped" id="datatable_default">
                 ...
                 <td class="text-right py-0 align-middle">
                    <div class="btn-group btn-group-sm">
                      <a href="edittipousuarios.php?id='.$row['idtipo_usuario'].'" class="btn btn-info"><i class="fas fa-edit"></i> Editar</a>
                      <a data-id="'.$row['idtipo_usuario'].'" class="btn btn-danger btn-delete_tipo_usuario"><i class="fas fa-trash"></i> Deletar</a>
