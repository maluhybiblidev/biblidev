        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index.php">Empréstimos</a></li>
                ...
                <table class="table table-bordered table-striped" id="datatable_default">
                  ...
                  foreach ($resp_array as $row) {
                    ...
                    if (isset($row['id']) != NULL) {
                      ...
                      $delete_button = "";
                      if (isset($row['data_locacao']) == NULL) {
                        $delete_button = '<a data-id="'.$row['id'].'" data-idemprestimo="'.$row['idemprestimo'].'" class="btn btn-danger btn-delete_livro_emprestimo"><i class="fas fa-trash"/></i></a>';
                      }
...
//Modal Deletar Livro Empréstimo
echo '
      <div class="modal fade" id="modalDeleteLivroEmprestimo">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              <section class="content">
                <div class="justify-content">
                  ...
                  <div>
                    <h3 class="text-center" id="tituloDeleteLivroEmprestimo"></h3>
                    <p class="text-muted text-center" id="mensagemDeleteLivroEmprestimo"></p>
                  </div>
                </div>              
              </section>
            </div>
            <div class="modal-footer justify-content-between">
              ...
              <a id="deleteLivroEmprestimoYes" type="submit" class="btn btn-danger">Deletar</a>
            </div>
          </div>
        </div>
      </div>
