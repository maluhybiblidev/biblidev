        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Categorias Livros</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Categorias Livros</h3>
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 190px;">
                        <div class="box-footer clearfix no-border">
                            <a href="addcategorialivros.php" type="button" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Categoria Livros </a>
                        </div>
                  </div>
                </div>                
              </div>
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped" id="datatable_default">
                  ...
                  $resp_json = $categoriaslivros->GetCategoriasLivro();
...
echo '
<form action="../../App/Database/deletecategorialivros.php" method="POST">
